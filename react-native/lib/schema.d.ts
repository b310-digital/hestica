...
export interface paths {
  ...
  "/items/recipes_ingredients": {
    /**
     * List Items
     * @description List the recipes_ingredients items.
     */
    get: operations["readItemsRecipesIngredients"];
    /**
     * Create an Item
     * @description Create a new recipes_ingredients item.
     */
    post: operations["createItemsRecipesIngredients"];
    /**
     * Delete Multiple Items
     * @description Delete multiple existing recipes_ingredients items.
     */
    delete: operations["deleteItemsRecipesIngredients"];
    /**
     * Update Multiple Items
     * @description Update multiple recipes_ingredients items at the same time.
     */
    patch: operations["updateItemsRecipesIngredients"];
  };
  "/items/recipes_ingredients/{id}": {
    /**
     * Retrieve an Item
     * @description Retrieve a single recipes_ingredients item by unique identifier.
     */
    get: operations["readSingleItemsRecipesIngredients"];
    /**
     * Delete an Item
     * @description Delete an existing recipes_ingredients item.
     */
    delete: operations["deleteSingleItemsRecipesIngredients"];
    /**
     * Update an Item
     * @description Update an existing recipes_ingredients item.
     */
    patch: operations["updateSingleItemsRecipesIngredients"];
  };
  "/items/recipes": {
    /**
     * List Items
...
export interface components {
  schemas: {
    ...
    ItemsInstructions: {
      ...
      description?: string | null;
      title?: string | null;
      recipe_id?: string | components["schemas"]["ItemsRecipes"] | null;
    };
    ItemsRecipesIngredients: {
      id?: number;
      recipes_id?: string | components["schemas"]["ItemsRecipes"] | null;
      item?: (string | components["schemas"]["ItemsIngredients"])[] | null;
    ...
    ItemsRecipes: {
      ...
      yield?: number | null;
      ingredients?:
        | (number | components["schemas"]["ItemsRecipesIngredients"])[]
        | null;
      instructions?:
        | (number | components["schemas"]["ItemsInstructions"])[]
        | null;
    };
  };
  responses: {
...
export interface operations {
  ...
  createItemsInstructions: {
    ...
    requestBody?: {
      content: {
        "application/json":
          | components["schemas"]["ItemsInstructions"][]
          | components["schemas"]["ItemsInstructions"];
      };
    };
    responses: {
  ...
  readItemsRecipesIngredients: {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data?: components["schemas"]["ItemsRecipesIngredients"][];
            meta?: components["schemas"]["x-metadata"];
          };
        };
      };
  ...
  createItemsRecipesIngredients: {
    ...
    requestBody?: {
      content: {
        "application/json":
          | components["schemas"]["ItemsRecipesIngredients"][]
          | components["schemas"]["ItemsRecipesIngredients"];
      };
    };
    responses: {
   ...
   * @description Retrieve a single recipes_ingredients item by unique identifier.
   */
  readSingleItemsRecipesIngredients: {
    parameters: {
      query?: {
        fields?: components["parameters"]["Fields"];
        meta?: components["parameters"]["Meta"];
   ...
   * @description Delete an existing recipes_ingredients item.
   */
  deleteSingleItemsRecipesIngredients: {
    parameters: {
      path: {
        /** @description Index of the item. */
        id: number | string;
   ...
   * @description Update an existing recipes_ingredients item.
   */
  updateSingleItemsRecipesIngredients: {
    parameters: {
      query?: {
        fields?: components["parameters"]["Fields"];
        meta?: components["parameters"]["Meta"];
    ...
    requestBody?: {
      content: {
        "application/json": components["schemas"]["ItemsRecipesIngredients"];
      };
    };
    responses: {
      /** @description Successful request */
  ...
  createItemsRecipes: {
    ...
    requestBody?: {
      content: {
        "application/json":
          | components["schemas"]["ItemsRecipes"][]
          | components["schemas"]["ItemsRecipes"];
      };
    };
    responses: {
